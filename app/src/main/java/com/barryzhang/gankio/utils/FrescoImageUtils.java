...
//        draweeView.setHierarchy(hierarchy);
    ...
    public static void loadPayLabelsUI(final SimpleDraweeView draweeView,  String url , final int imageHeight){
        ControllerListener<ImageInfo> controllerListener = new BaseControllerListener<ImageInfo>() {
            ...
            public void onFinalImageSet(
                ...
                LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) draweeView.getLayoutParams();
                lp.height = imageHeight;
                lp.width = imageInfo.getWidth() * imageHeight / imageInfo.getHeight();
